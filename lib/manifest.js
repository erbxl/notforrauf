  ...
  window.__BRAND__ = {
    ...
    people: {
      ru: [
        ...
        { name: "Ляйла Халиуллина", role: "Документация и гомологация", d: "Ведёт документацию и сопровождение процесса в Испании." }
      ]
    },
    ...
    testimonials: {
      ru: [
        ...
        { quote: "Отзыв: доктор Рауф ответил на все интересующие меня вопросы, по времени ограничений особых не было, общались 1-1,5 ч где-то. Приятный в общении, располагающий к себе человек.", name: "Павел Ткаченко" },
        { quote: "Вам спасибо огромное!!! Вы вселили надежду, когда я ещё в РФ была, поддерживали всё это время, и только благодаря этому мы решились переехать, и сейчас вот наконец-то можно строить уже твёрдые планы 😍 Но на самом деле то, что важно — Ваша результативность, как чётко Вы знаете свое дело, и слава о Вас ходит по всем форумам и чатам.", name: "Виктория Симонян" },
        { quote: "Благодарю Рауфа и Лайлу Халиулиных за очень профессиональный подход к процессу омологации и признания диплома в Испании! С их помощью можно не находясь в стране сделать все важные работы по документам, что очень удобно. Все происходит под ключ! Рекомендую!", name: "Ислам Каримов" }
      ]
    },
